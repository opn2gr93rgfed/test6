#!/usr/bin/env python3
"""
Тест для диагностики проблемы с user_code
"""
...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("button", name="0").click()
    page.get_by_role("heading", name="Want to get more quotes for your")
...
print("="*80)
print("ТЕСТ ГЕНЕРАЦИИ USER_CODE")
print("="*80)
...
try:
    ...
    output_file = "/home/user/test6/debug_generated_script.py"
    ...
    questions_count = script.count("QUESTIONS_POOL")
    print(f"\n[7] Найдено упоминаний QUESTIONS_POOL: {questions_count}")
...
print("\n" + "="*80)
print("Для просмотра сгенерированного скрипта:")
print("  cat debug_generated_script.py | less")
print("="*80)
